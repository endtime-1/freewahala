                ...
                <div className="flex items-center justify-between h-14 sm:h-16 md:h-20">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <Link
                                href="/login"
                                className="text-xs sm:text-sm font-medium text-gray-700 hover:text-gray-900 py-1.5 px-2.5 sm:px-3 rounded-lg hover:bg-gray-100 transition-colors"
                            >
                                Log in
                            </Link>
                            <Link
                                href="/signup"
                                className="text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-orange-500 to-red-500 py-1.5 px-3 sm:px-4 rounded-lg hover:opacity-90 transition-opacity shadow-sm"
                            >
                                Sign up
                            </Link>
                        </div>

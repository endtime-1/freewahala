...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 to-orange-50 flex items-center justify-center px-4 py-8">
                        ...
                        <form onSubmit={handleSendOtp}>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    >
                                        ...
                                        <div className="text-xs text-gray-500">I'm a tenant</div>
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        ...
                                        <div className="text-xs text-gray-500">I'm a landlord</div>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500"
                                />
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData({ ...formData, phone: formatPhoneForDisplay(e.target.value) })}
                                        placeholder="024 XXX XXXX"
                                        className="w-full pl-24 pr-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 text-lg"
                                    />
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleVerifyOtp}>
                            <div className="mb-6">
                                <input
                                    ...
                                    placeholder="••••••"
                                    maxLength={6}
                                    className="w-full px-4 py-4 border border-gray-200 rounded-xl text-2xl text-center tracking-widest focus:outline-none focus:ring-2 focus:ring-pink-500"
                                />
                            </div>
